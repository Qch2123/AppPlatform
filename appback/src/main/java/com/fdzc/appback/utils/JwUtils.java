package com.fdzc.appback.utils;
...
public class JwUtils {
     ...
     * @return
     */
    public static  String getToken(String usercode){//账号
    ...
    public static String getUserCode(String token){
        ...
        try {
            usercode = Jwts.parser().setSigningKey("jf3q-jwt").parseClaimsJws(token).getBody().getSubject();
